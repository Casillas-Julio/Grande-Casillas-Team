...
public class HelpMenuView extends View{
    ...
    private final String MOVES = "\n"
            ...
            + "\nprompted to continune the journey. The "
            + "\nplayer chooses to move 1 to 3 spaces,  "
            + "\nthe game will assign a random character"
            + "\nand challenges to be faced next.       "
            + "\n---------------------------------------";
    ...
    private final String FRUITS = "\n"
            ...
            + "\nthe game with 10 fruits representing faith"
            + "\nand obedience that he or she already has. "
            + "\n------------------------------------------";
